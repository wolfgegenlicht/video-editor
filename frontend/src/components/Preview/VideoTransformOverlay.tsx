...
export default function VideoTransformOverlay({ clip, outerRef }: Props) {
  ...
  const cornerClass = "absolute size-2.5 bg-teal-400 rounded-sm shadow-sm";
  ...
  return (
    ...
    >
      ...
      >
        <div className="size-2.5 rounded-full bg-violet-400 shadow-sm" />
      ...
      <div role="presentation" className={`${cornerClass} -top-1.5 -left-1.5 cursor-nw-resize pointer-events-auto`} onPointerDown={onScaleStart} />
      <div role="presentation" className={`${cornerClass} -top-1.5 -right-1.5 cursor-ne-resize pointer-events-auto`} onPointerDown={onScaleStart} />
      <div role="presentation" className={`${cornerClass} -bottom-1.5 -left-1.5 cursor-sw-resize pointer-events-auto`} onPointerDown={onScaleStart} />
      <div role="presentation" className={`${cornerClass} -bottom-1.5 -right-1.5 cursor-se-resize pointer-events-auto`} onPointerDown={onScaleStart} />
    </div>
  );
}
